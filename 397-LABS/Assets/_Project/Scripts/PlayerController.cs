    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        private void UpdateMovement()
        {
            ...
            if(adjustedDirection.magnitude > 0f)
            {
                ...
                HandleRotations(adjustedDirection);
                HandleMovement(adjustedDirection);
            }
            else
            {
                //not change the roaton or movement, but need to apply rigidbody Y movement for gravity
        ...
        private void HandleRotations(Vector3 adjustedMovement) 
        {
